...
export default function Profile() {
  ...
  const isUnchanged = username === user?.username && (profession || '') === (user?.profession || '');
  ...
  const handleUpdateProfile = async () => {
    ...
    setLoading(true);
    try {
      await authAPI.updateProfile(username, profession || null);
          ...
          <div className="space-y-6">
            ...
            <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
              <CardHeader>
                ...
                <CardDescription>
                  Kullanıcı adı ve meslek bilgilerinizi güncelleyebilirsiniz
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Meslek bilginizi güncel tutun (isteğe bağlı)
                  </p>
                </div>
                ...
                <Button
                  ...
                  disabled={loading || !username || isUnchanged}
                  className="w-full"
                >
